				      ...
				      bool master_diff)
{
	...
	case PTP_PS_INITIALIZING:
		...
		case PTP_EVT_FAULT_DETECTED:
			new_state = CONFIG_PTP_FAULTY_PRESENT ?
					PTP_PS_FAULTY : new_state;
			break;
		case PTP_EVT_INIT_COMPLETE:
			new_state = CONFIG_PTP_LISTENING_PRESENT ?
	...
	case PTP_PS_FAULTY:
		...
		case PTP_EVT_DESIGNATED_DISABLED:
			new_state = CONFIG_PTP_DISABLED_PRESENT ?
	...
	case PTP_PS_LISTENING:
		...
		case PTP_EVT_RS_MASTER:
			new_state = CONFIG_PTP_PRE_MASTER_PESENT ?
		...
		case PTP_EVT_RS_SLAVE:
			new_state = CONFIG_PTP_UNCALIBRATED_PRESENT ?
